...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
    <title>Admin Login | TPS</title>
  </head>
  <body style="background: linear-gradient(135deg, #ffffff, #fafbfc, #f5f7f9, #f0f2f5);">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#" style="font-size:30px;"><strong>TPS</strong></a>
  ...
  <img class="card-img-top mx-auto" src="images\logo.jpg" style="width: 60%; border-radius: 50%; " alt="Card image cap" >
  <div class="card-body">
