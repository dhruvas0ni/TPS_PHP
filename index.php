...
<body style="background: linear-gradient(135deg, #ffffff, #f0f4f8, #e8ecf1, #dfe5eb);">

	<div class="container">
<a href="#" target="_blank"><img src="images\logo.jpg" alt="" height="100px" width="100px" style="border-radius: 50%; margin-top: 20px;" ></a><br><hr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="images\logo.jpg" width="100px" height="100px" alt="" style="border-radius: 50%;"></center>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					<div class='col-sm-4 col-md-2'>
						<img src='upload_images/$image' alt='' style='width: 150px; height: 150px; border-radius: 50%;' ><br>
